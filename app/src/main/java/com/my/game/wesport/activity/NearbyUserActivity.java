...
public class NearbyUserActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.InfoWindowAdapter, GoogleMap.OnInfoWindowClickListener, GeoQueryEventListener {
    ...
    private final double GEO_FIRE_RADIUS = 80467.2;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        map.animateCamera(CameraUpdateFactory.newLatLngZoom(location, 12.9f));
    ...
    private void setupGeoFire(LatLng latLng) {
        ...
        geoFire = new GeoFire(FirebaseHelper.getLocationRef());
        try {
            geoQuery = geoFire.queryAtLocation(
                    new GeoLocation(latLng.latitude, latLng.longitude), GEO_FIRE_RADIUS);
