...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, PlaceSelectionListener,
    ...
    public static final int REQUEST_CODE_ACTIVITY = 33;
...
//            new InfoWindowRefresher(marker)
    ...
    public void onPlaceSelected(Place place) {
        ...
        Intent intent = GameEditActivity.newIntent(MapsActivity.this, place.getId(), null, placeLat, placeLon, address);
    ...
    public void onInfoWindowClick(Marker marker) {
        try {
            ...
            Toast.makeText(this, selectedGame + " " + getString(R.string.save_game) + " " + address + "  " +
                    getString(R.string.save_game_text), Toast.LENGTH_SHORT).show();
            Intent intent = GameEditActivity.newIntent(MapsActivity.this, parkModel.getId(), null, marLat, marLon, address);
            startActivityForResult(intent, REQUEST_CODE_ACTIVITY);
